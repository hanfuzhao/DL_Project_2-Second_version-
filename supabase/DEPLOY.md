...
- Sends them to the SafeType DistilBERT API at `https://dl-project-2-second-version.onrender.com/api/predict`
...
- Clicking any message on the dashboard directly calls the API for detailed 10-category analysis
